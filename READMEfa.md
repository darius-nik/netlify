...
> فورک کنید، به گیت‌هاب متصل شوید، یک متغیر محیطی تنظیم کنید و در ۶۰ ثانیه راه‌اندازی شوید – بدون محدودیت پهنای باند (۱۰۰ گیگابایت در طرح رایگان، بسیار فراتر از محدودیت ۱۰ گیگابایتی Vercel).
...
|--------|--------------------------|--------------------------------|
| **پهنای باند** | ۱۰ گیگابایت در ماه | ۱۰۰ گیگابایت در ماه (طرح رایگان) |
...
طرح رایگان Netlify دارای **۱۰۰ گیگابایت در ماه** است. اگر به پهنای باند بیشتری نیاز دارید، به طرح Pro (۱ ترابایت) ارتقا دهید یا یک CDN سفارشی اضافه کنید. برای پهنای باند **نامحدود**، [Cloudflare Workers](https://workers.cloudflare.com/) را در نظر بگیرید – اما نیازمند بازنویسی پروکسی برای محیط Workers خواهد بود.
